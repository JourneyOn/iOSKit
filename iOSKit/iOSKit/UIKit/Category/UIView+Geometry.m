...
{
    self.frame = CGRectMake(self.frame.origin.x - (frameWidth - self.frame.size.width)/2.f, self.frame.origin.y, frameWidth, self.frame.size.height);
}
...
{
    self.frame = CGRectMake(self.frame.origin.x, self.frame.origin.y - (frameHeight - self.frame.size.height)/2.f, self.frame.size.width, frameHeight);
}
